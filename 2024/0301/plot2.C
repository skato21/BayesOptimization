{
  ...
  // const int t0 = 1709290740 - 788918400; // Mar. 1, 10:59:00
  
  // const int t1 = 1709291540 - 788918400; // Mar. 1, 11:12:20
  ...
  TF1 *fdcctvsrate = new TF1("fdcctvsrate", "-[0]*x*x-[1]*x", 0, 100);
  fdcctvsrate->SetParLimits(0, 1e-6, 1e-5);
  fdcctvsrate->SetParLimits(1, 0,    1e-1);
  fdcctvsrate->SetLineColor(2);
  
  TCanvas *cdcctvsrate = new TCanvas("cdcctvsrate", "cdcctvsrate", 600, 600);
  cdcctvsrate->cd(1);
  gdcctvsrate->Fit(fdcctvsrate, "NOME", "", 80, 100);
  gdcctvsrate->Draw("AP");
