...
/* Generated from ../O.Common/libera.dbd */
...
epicsShareExtern reg_func pvar_func_StriplineHERRegistrar,
    pvar_func_StriplineLERRegistrar, pvar_func_arrInitialize,
...
int libera_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/skato/work/2023/TestFunction/epicsApp";
    ...
    pvar_func_StriplineHERRegistrar();
    pvar_func_StriplineLERRegistrar();
...
/* libera_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"libera_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    libera_registerRecordDeviceDriver(*iocshPpdbbase);
}
