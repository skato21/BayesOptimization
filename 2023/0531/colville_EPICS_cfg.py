...
def Colville_EPICS_fun(inputs):
    ...
    caput ('LIiMG:PY_R0_63:IWRITE:KBP', inputs["x4"])
    caput ('LIiMG:PY_R0_63:IWRITE:KBP', inputs["x5"])
    time.sleep(2.0)
...
generator_options.acq.beta = 5.0
...
filepath = '/nfs/sadstorage-users/mitsuka/work/2023/0515/positron_study_log/'
